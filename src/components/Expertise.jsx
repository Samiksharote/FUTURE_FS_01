      ...
      <div className="expertise-container">
        ...
        <div className="expertise-top-row">
          ...
          <div className="expertise-header">
            ...
            <h2>
              Building Modern Digital Solutions with{" "}
              <span>Code & AI</span>
            </h2>

            <p>
              Combining full-stack development, artificial intelligence,
              and modern tools to create impactful digital experiences.
            </p>
          </div>


          {/* =========================
              CARD 01 (Wrapped for Mobile Spacing)
          ========================== */}
